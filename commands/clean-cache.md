...
tokenplan-usage-hud@tokenplan-usage-hud`) again to refresh the
remaining dir, or just leave it — `install.sh` will detect the carried
state from the previous version automatically.
